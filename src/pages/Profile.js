        ...
        <div className="container">
          ...
          <div className="profile_main">
            <div className="profile_right">
              ...
              <button className={showProfile ? 'active' : ''} onClick={() => handleButtonClick('profile')}>Profile</button>
              <button className={showUploads ? 'active' : ''} onClick={() => handleButtonClick('uploads')}>My Uploads</button>
            </div>
            <div className="profile_left">
              <button className={showEdit ? 'active' : ''} onClick={() => handleButtonClick('edit')}>Account settings</button>
